        ...
        Ext.Ajax.request({
            ...
            failure: function (transport) {
                ...
                Ext.MessageBox.show({
                    ...
                    msg: 'Hmm...I can&apos;t talk to the server, check you have network access.<br/>Failing that try reloading the page<br/>If it still fails then contact your system admin',
